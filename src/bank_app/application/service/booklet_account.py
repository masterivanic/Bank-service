...
from bank_app.application.ports.api.booklet_account_use_case import BookletAccount

if TYPE_CHECKING:
    from bank_app.application.domain.service.booklet_account import BookletAcountService
